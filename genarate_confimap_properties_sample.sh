...
### GitleaksFullScan
PROPERTIES_PATH="$PROPERTIES_DIR/code_gitleaks_full_scan.properties"
echo "DEBUG=$DEBUG" >> "$PROPERTIES_PATH"
echo "AWS_REGION=$AWS_REGION" >> "$PROPERTIES_PATH"
echo "AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID" >> "$PROPERTIES_PATH"
echo "AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY" >> "$PROPERTIES_PATH"
...
### JIRA
PROPERTIES_PATH="$PROPERTIES_DIR/diagnosis_jira.properties"
echo "AWS_REGION=$AWS_REGION" >> "$PROPERTIES_PATH"
echo "AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID" >> "$PROPERTIES_PATH"
echo "AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY" >> "$PROPERTIES_PATH"
echo "AWS_SESSION_TOKEN=$AWS_SESSION_TOKEN" >> "$PROPERTIES_PATH"
echo "DIAGNOSIS_JIRA_URL=$DIAGNOSIS_JIRA_URL" >> "$PROPERTIES_PATH"
echo "DIAGNOSIS_JIRA_USER_ID=$DIAGNOSIS_JIRA_USER_ID" >> "$PROPERTIES_PATH"
echo "DIAGNOSIS_JIRA_USER_PASSWORD=$DIAGNOSIS_JIRA_USER_PASSWORD" >> "$PROPERTIES_PATH"
