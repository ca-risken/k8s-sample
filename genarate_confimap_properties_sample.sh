...
## OSINT
WEBSITE_QUEUE_NAME="osint-website"
WEBSITE_QUEUE_URL="http://queue.middleware.svc.cluster.local:9324/queue/osint-website"
...
echo "AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY" >> "$PROPERTIES_PATH"
echo "AWS_SESSION_TOKEN=$AWS_SESSION_TOKEN" >> "$PROPERTIES_PATH"
echo "WEBSITE_QUEUE_NAME=$WEBSITE_QUEUE_NAME" >> "$PROPERTIES_PATH"
echo "WEBSITE_QUEUE_URL=$WEBSITE_QUEUE_URL" >> "$PROPERTIES_PATH"
