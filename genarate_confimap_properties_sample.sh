...
CORE_ADDR=core.risken.svc.cluster.local:8080

## DataSource
DATA_SOURCE_API_SVC_ADDR=datasource-api.risken.svc.cluster.local:8081
...
echo "CORE_ADDR=$CORE_ADDR" >> "$PROPERTIES_PATH"
echo "DATA_SOURCE_API_SVC_ADDR=$DATA_SOURCE_API_SVC_ADDR" >> "$PROPERTIES_PATH"
echo "DEBUG=$DEBUG" >> "$PROPERTIES_PATH"
...
echo "AZURE_CLIENT_ID=${AZURE_CLIENT_ID}" >> "$PROPERTIES_PATH" # Azure
echo "AZURE_CLIENT_SECRET=${AZURE_CLIENT_SECRET}" >> "$PROPERTIES_PATH" # Azure
echo "AZURE_TENANT_ID=${AZURE_TENANT_ID}" >> "$PROPERTIES_PATH" # Azure
echo "CORE_SVC_ADDR=$CORE_ADDR" >> "$PROPERTIES_PATH"
...
## Azure
### Prowler
PROPERTIES_PATH="$DATASOURCE_PROPERTIES_DIR/datasource_azure_prowler.properties"
echo "AWS_REGION=$AWS_REGION" >> "$PROPERTIES_PATH"
echo "AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID" >> "$PROPERTIES_PATH"
echo "AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY" >> "$PROPERTIES_PATH"
echo "AWS_SESSION_TOKEN=$AWS_SESSION_TOKEN" >> "$PROPERTIES_PATH"
echo "AZURE_CLIENT_ID=$AZURE_CLIENT_ID" >> "$PROPERTIES_PATH"
echo "AZURE_CLIENT_SECRET=$AZURE_CLIENT_SECRET" >> "$PROPERTIES_PATH"
echo "AZURE_TENANT_ID=$AZURE_TENANT_ID" >> "$PROPERTIES_PATH"
echo "CORE_SVC_ADDR=$CORE_ADDR" >> "$PROPERTIES_PATH"
echo "DATA_SOURCE_API_SVC_ADDR=$DATA_SOURCE_API_SVC_ADDR" >> "$PROPERTIES_PATH"
